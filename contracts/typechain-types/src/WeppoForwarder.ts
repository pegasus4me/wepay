...
export interface WeppoForwarderInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "eip712Domain"
      | "execute"
...
export interface WeppoForwarder extends BaseContract {
  connect(runner?: ContractRunner | null): WeppoForwarder;
  waitForDeployment(): Promise<this>;

  interface: WeppoForwarderInterface;
