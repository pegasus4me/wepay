...
export class InsufficientFundsError extends WePayError {
...
export class AuthenticationError extends WePayError {
...
export class PaymentFailedError extends WePayError {
